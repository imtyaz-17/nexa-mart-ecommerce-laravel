                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route('admin.brands.index')}}'" class="btn btn-default btn-sm">
                            ...
                            @foreach($brands as $brand)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.categories.delete', $brand->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDeletion();">
                                            @csrf
                                            @method('DELETE')
