            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        ...
                        <a href="{{route('admin.products.index')}}" class="small-box-footer text-dark">More info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-6">
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>${{number_format($currentMonthSale,2)}}</h3>
                            <p>This Month Sale</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                ...
                <div class="col-lg-4 col-6">
                    <div class="small-box card">
                        <div class="inner">
                            <h3>${{number_format($lastThirtyDaysSale,2)}}</h3>
                            <p>Last 30Days Sale</p>
                        </div>
                        <div class="icon">
                            <i class="ion ion-person-add"></i>
                        </div>
