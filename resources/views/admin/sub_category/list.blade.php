                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route('admin.subcategories.index')}}'" class="btn btn-default btn-sm">
                            ...
                            @foreach($subcategories as $subcategory)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.subcategories.delete', $subcategory->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDeletion();">
                                            @csrf
                                            @method('DELETE')
