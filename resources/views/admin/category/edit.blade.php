                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" value="{{$category->slug}}" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug">
                                    @error('slug')
                                    <p class="invalid-feedback">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                @if(!empty($category->image))
                                    <div>
                                        <img src="{{asset('uploads/categoryImage/thumb/'.$category->image)}}" alt="" width="200" height="100">
                                    </div>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control @error('status') is-invalid @enderror">
                                        ...
                                        <option  value="0"  {{ $category->status == false ? 'selected' : '' }}>Block</option>
                                    </select>
                                    @error('status')
                                    <p class="invalid-feedback">{{$message}}</p>
                                    @enderror
