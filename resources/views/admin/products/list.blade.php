                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route('admin.products.index')}}'" class="btn btn-default btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($productImage->image))
                                            <img src="{{asset('/uploads/productImage/thumb/'.$productImage->image)}}" class="img-thumbnail" height="50" width="50" alt="">
                                        @else
                                            <img src="{{asset('/admin-assets/img/default-150x150.png')}}" class="img-thumbnail" alt="" height="50" width="50">
                                        @endif
                                    </td>
                                    <td>{{$product->title}}</td>
                                    <td>${{$product->price}}</td>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.products.delete', $product->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDeletion();">
                                            @csrf
                                            @method('DELETE')
