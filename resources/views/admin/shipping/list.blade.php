        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('admin.shipping.create')}}" class="btn btn-primary">New Shipping</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <button type="button" onclick="window.location.href='{{route('admin.shipping.index')}}'" class="btn btn-default btn-sm">
                            ...
                            @foreach($shippingCharges as $shippingCharge)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('admin.shipping.delete', $shippingCharge->id) }}" method="POST" style="display:inline;" onsubmit="return confirmDeletion();">
                                            @csrf
                                            @method('DELETE')
