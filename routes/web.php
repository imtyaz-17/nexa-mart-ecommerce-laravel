...
Route::post('/apply-discount',[CartController::class,'applyDiscount'])->middleware('auth')->name('cart.apply-discount');
Route::post('/remove-coupon',[CartController::class,'removeCoupon'])->middleware('auth')->name('cart.remove-coupon');
